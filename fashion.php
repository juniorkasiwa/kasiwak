...
<style>
h1,h2,h3,h4,h5,h6 {font-family: Times, "Times New Roman", sans-serif;}
body {font-family: Times, "Times New Roman", sans-serif;"}
</style>
</head>
...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>DAILY FASHION</b></h1>
    <h6>Welcome to the dreamers fashion <span class="w3-tag"></span></h6>
  </header>
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="images/f4.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="images/art1.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-16">
          ...
          <div id="demo2" style="display:none">
            <div class="w3-row">
              <hr>
              <div class="w3-col l2 m3">
                <img src="images/f4.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="images/f2.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="images/hat.jpg" alt="Runway" style="width:100%" class="w3-padding-16">
